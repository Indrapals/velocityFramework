	 ...
	 ATUTestRecorder recorder;
	  ...
	  public void vehicleCheckMenuTest_001() throws Exception{
	    ...
	    try {
			...
			String arr[] = {"", "", "Vehicle Check Dashboard", "Due Dates Dashboard", "Defect Management", "How It Works", "Manage Fleet", "Manage Groups", "Manage Questions", "Reports", "Alerts"};
			...
			for(int i=0;i<vcpobj.vehiclecheckDropdownlist.size();i++)
	        {
	            ...
	            Assert.assertEquals(arr[i],vcpobj.vehiclecheckDropdownlist.get(i).getText(),"Verify vehicle Dropdown List");
	    ...
	    public void vehicleCheckTileTest_003() throws Exception{
	     ...
	     public void vehiclesTileTest_004() throws Exception{
		    ...
		    try {
				...
				for(int i=0;i<vcpobj.manageVehiclesHeaderList.size();i++)
		        {
		          ...
		          Assert.assertEquals(vehicleHeaderListarr[i],vcpobj.manageVehiclesHeaderList.get(i).getText(),"Vehicle headerlist verify");
	     ...
	     public void vehiclesaddButtonPopupTest_005() throws Exception{
		    try {
	            ...
	            Assert.assertEquals(DueDatesarr[i],vcpobj.dueDatesCalanderList.get(i).getText(),"Duedates calander list verify ");
				}
