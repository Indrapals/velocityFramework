...
public class TestLinkIntegration {
	...
	public static final String BUILD_NAME = "POC-Build";
	 ...
	 public static void updateResult(String testCaseName, String exception, String results)    throws TestLinkAPIException, IOException
	 {
	      TestLinkAPIClient testlink = new TestLinkAPIClient(ConfigProperties.getObject("TESTLINK_KEY"),ConfigProperties.getObject("TestLinkUrl"));
